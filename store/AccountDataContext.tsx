    ...
    case AuthActions.UPDATE:
      return {
        ...
        user: action.payload
          ? {
              ...accountData.user,
              email: action.payload.email ?? accountData.user?.email,
              firstName:
                action.payload.firstName ?? accountData.user?.firstName,
              lastName: action.payload.lastName ?? accountData.user?.lastName,
            }
          : accountData.user,
      };
